 ...
 * @author RollW
 */
public final class QueryComplexityBudget {
    private static final QueryComplexityBudget DEFAULTS = new QueryComplexityBudget(8, 100, 20, 100, 256);
     ...
     */
    public static QueryComplexityBudget defaults() {
        return DEFAULTS;
    }
