...
/**
 * Generic bounded cache retention controls independent of a cache vendor.
 *
 * @author RollW
 */
public final class CacheProfile {
    ...
    /**
     * Returns whether the implementation should collect operational statistics.
     *
    ...
    public static final class Builder {
        ...
        /**
         * Enables or disables operational statistics collection.
         *
         * @param recordStats whether statistics should be collected
         * @return this builder
         */
        ...
        public CacheProfile build() {
            return new CacheProfile(maximumSize, expireAfterWrite, expireAfterAccess, recordStats);
        }
