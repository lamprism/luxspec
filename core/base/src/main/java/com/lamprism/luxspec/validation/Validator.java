...
public interface Validator<T> {
     ...
     */
    static Validator<String> nonBlank(String label) {
     ...
     */
    static Validator<String> noWhitespace(String label) {
        String nonBlankLabel = requireLabel(label);
        return of(
     ...
     */
    static Validator<String> noControlCharacters(String label) {
        String nonBlankLabel = requireLabel(label);
        return of(
                Validator::hasNoControlCharacters,
     ...
     */
    static Validator<String> maxLength(String label, int maximumLength) {
        String nonBlankLabel = requireLabel(label);
        if (maximumLength < 1) {
     ...
     */
    static <T> Validator<T> oneOf(String label, Set<? extends T> allowedValues) {
        String nonBlankLabel = requireLabel(label);
