...
class LuxspecAuditAutoConfigurationTest {
        ...
        contextRunner
                ...
                .run(context -> {
                    ...
                    assertThat(entries.get(0).eventName())
                            .isEqualTo(SecurityAudit.FIREWALL_RULE_FAILED);
    ...
    void selectsTheAuditFailureHandlerByItsGenericContext() {
        contextRunner
                .withUserConfiguration(GenericFailureHandlerConfiguration.class)
                .withBean(AuditSink.class, () -> entry -> {
                })
    ...
    static class GenericFailureHandlerConfiguration {
        @Bean
