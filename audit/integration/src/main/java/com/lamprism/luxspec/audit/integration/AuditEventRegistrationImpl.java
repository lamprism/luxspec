 ...
 * event names, and translators are assembled from one source.</p>
 *
 * @author RollW
 */
public class AuditEventRegistrationImpl implements AuditEventRegistration {
     ...
     */
    public AuditEventRegistrationImpl(EventDispatcher dispatcher, AuditPublisher publisher) {
