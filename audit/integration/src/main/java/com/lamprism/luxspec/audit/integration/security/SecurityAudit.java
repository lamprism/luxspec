...
/**
 * Stable security audit identifiers and fields.
 *
 * <p>Fields never publish credentials, grants, or token material.</p>
 *
 * @author RollW
 */
public final class SecurityAudit {
    ...
    public static final QueryField<String> SECURITY_SUBJECT_TYPE = QueryField.of(
            "security.subjectType",
            String.class
    );
    public static final QueryField<String> SECURITY_SUBJECT_ID = QueryField.of(
            "security.subjectId",
            String.class
    );
    public static final QueryField<String> SECURITY_REASON_CODE = QueryField.of(
            "security.reasonCode",
            String.class
    );
    public static final QueryField<Long> SECURITY_DURATION_MILLIS = QueryField.of(
            "security.durationMillis",
            Long.class
    );
    public static final QueryField<String> SECURITY_RULE_TYPE = QueryField.of("security.ruleType", String.class);
    public static final QueryField<String> SECURITY_CREDENTIAL_TYPE = QueryField.of(
            "security.credentialType",
            String.class
    );
    public static final QueryField<String> SECURITY_TOKEN_OPERATION = QueryField.of(
            "security.tokenOperation",
            String.class
    );
    public static final QueryField<String> SECURITY_TOKEN_RESULT = QueryField.of(
            "security.tokenResult",
            String.class
    );
    public static final QueryField<String> SECURITY_TOKEN_KINDS = QueryField.of(
            "security.tokenKinds",
            String.class
    );
    public static final QueryField<Long> SECURITY_RETRY_AFTER_MILLIS = QueryField.of(
            "security.retryAfterMillis",
            Long.class
    );
