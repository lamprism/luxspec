...
/**
 * Contributes audit definitions owned by configuration integration.
 *
 * @author RollW
 */
public final class ConfigAuditEventDefinitionContributor implements AuditEventDefinitionContributor {
    @Override
    public void contribute(AuditEventDefinitionRegistrar registrar) {
        ...
        nonNullRegistrar.register(ConfigSourceChangedAuditTranslator.definition());
        nonNullRegistrar.register(ConfigChangedAuditTranslator.definition());
    }
}
