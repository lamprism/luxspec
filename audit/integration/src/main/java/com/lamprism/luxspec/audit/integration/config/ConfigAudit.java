...
/**
 * Stable configuration audit identifiers and fields.
 *
 * <p>Event names are explicit protocol identifiers and fields contain state and origin metadata,
 * never configuration values.</p>
 *
 * @author RollW
 */
public final class ConfigAudit {
    ...
    public static final QueryField<String> CONFIG_PREVIOUS_STATE = QueryField.of(
            "config.previousState",
            String.class
    );
    public static final QueryField<String> CONFIG_CURRENT_STATE = QueryField.of(
            "config.currentState",
            String.class
    );
    public static final QueryField<String> CONFIG_PREVIOUS_ORIGIN = QueryField.of(
            "config.previousOrigin",
            String.class
    );
    public static final QueryField<String> CONFIG_CURRENT_ORIGIN = QueryField.of(
