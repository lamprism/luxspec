 ...
 * @author RollW
 */
public final class ConfigChangedAuditTranslator implements AuditEventTranslator<ConfigChangedEvent> {
    @Override
    public AuditEntryContent translate(AuditEnvelope<ConfigChangedEvent> envelope) {
        ...
        AuditFieldSet fields = AuditFieldSet.builder()
                ...
                .put(LuxspecAuditFields.CONFIG_SENSITIVE, event.isSensitive())
                .put(LuxspecAuditFields.CONFIG_PREVIOUS_STATE, event.getPreviousState().name())
                .put(LuxspecAuditFields.CONFIG_CURRENT_STATE, event.getCurrentState().name())
                .put(LuxspecAuditFields.CONFIG_PREVIOUS_ORIGIN,
                        ConfigAuditTranslationSupport.origin(event.getPreviousOrigin()))
                .put(LuxspecAuditFields.CONFIG_CURRENT_ORIGIN,
