...
public final class AuditActor {
    ...
    public static final class Kind {
        private static final Normalizer<String> VALUE_NORMALIZER = Normalizer.of(String::trim)
                .validatedBy(
                        Validator.nonBlank("Audit actor kind")
                                .and(Validator.noWhitespace("Audit actor kind"))
                                .and(Validator.noControlCharacters("Audit actor kind"))
                );
    ...
    private static final Validator<String> ID_VALIDATOR = Validator.nonBlank("Audit actor ID");
