 ...
 * @author RollW
 */
public final class Argon2idPasswordParameters {
     ...
     */
    public Argon2idPasswordParameters(
            int memoryKiB,
            int iterations,
            int parallelism,
            int saltLength,
     ...
     */
    public static Argon2idPasswordParameters defaults() {
        return new Argon2idPasswordParameters(65_536, 3, 1, 16, 32);
    }
