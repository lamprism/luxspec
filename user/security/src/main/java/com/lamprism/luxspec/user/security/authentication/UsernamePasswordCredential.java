...
import com.lamprism.luxspec.security.authentication.Credential;
...
public final class UsernamePasswordCredential implements Credential {
     ...
     */
    public UsernamePasswordCredential(String username, CharSequence rawPassword) {
    ...
    public String toString() {
        return "UsernamePasswordCredential[username=" + username + ", rawPassword=redacted]";
    }
