...
public class Argon2idPasswordScheme implements PasswordScheme {
    ...
    private final Argon2idPasswordConfiguration parameters;
    ...
    public Argon2idPasswordScheme() {
        this(Argon2idPasswordConfiguration.defaults());
    }
     ...
     */
    public Argon2idPasswordScheme(Argon2idPasswordConfiguration parameters) {
    ...
    private static StoredPassword parse(EncodedPassword encodedPassword) {
        ...
        StoredParameterState storedParameters = parseParameters(segments.get(3));
    ...
    private static StoredParameterState parseParameters(String value) {
        ...
        return new StoredParameterState(memoryKiB, iterations, parallelism);
    }
    ...
    private static String format(byte[] salt, byte[] hash, Argon2idPasswordConfiguration parameters) {
    ...
    private static final class StoredParameterState {
        private final int memoryKiB;
        private final int iterations;
        private final int parallelism;

        private StoredParameterState(int memoryKiB, int iterations, int parallelism) {
