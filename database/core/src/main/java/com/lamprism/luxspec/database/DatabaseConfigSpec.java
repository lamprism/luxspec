...
public final class DatabaseConfigSpec {
    private static final ConfigPolicy BOOTSTRAP_ONLY = ConfigPolicy.sourceScope(ConfigSourceScope.BOOTSTRAP);
    ...
    public static final ConfigSpec<DatabaseType> TYPE = bootstrap(
            ...
            ConfigCodec.serialized(DatabaseType::of, DatabaseType::getName),
            null,
            false
    );
    public static final ConfigSpec<DatabaseTarget> TARGET = bootstrap(
            ...
            ConfigCodec.serialized(DatabaseTarget::parse, DatabaseTarget::toString),
            null,
            false
    );
    ...
    public static final ConfigSpec<SslMode> SSL_MODE = bootstrap(
            ...
            ConfigCodec.enumValue(SslMode.class),
            SslMode.DISABLED,
            false
    );
