...
public class SimpleObservationLink implements ObservationLink {
    ...
    private static String requireIdentifier(String value, String name) {
        ...
        ValidationRules.noControlCharacters(name).validate(nonNullValue);
        return nonNullValue;
    }
    ...
    private static String requireAttributeName(String value) {
        ...
        ValidationRules.noWhitespace("attribute name")
                .and(ValidationRules.noControlCharacters("attribute name"))
    ...
    private static String requireAttributeValue(String value) {
        ...
        ValidationRules.noControlCharacters("attribute value").validate(nonNullValue);
        return nonNullValue;
    }
}
