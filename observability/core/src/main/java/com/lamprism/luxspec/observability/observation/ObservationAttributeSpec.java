...
public final class ObservationAttributeSpec<T> {
    private static final Validator<String> NAME_VALIDATOR = Validator
            .nonBlank("Observation attribute name")
            .and(Validator.noWhitespace("Observation attribute name"))
            .and(Validator.noControlCharacters("Observation attribute name"));
