...
public final class ObservationName {
    private static final Normalizer<String> VALUE_NORMALIZER = Normalizer.of(String::trim)
            .validatedBy(
                    Validator.nonBlank("Observation name")
                            .and(Validator.noControlCharacters("Observation name"))
            );

    private final String value;

    private ObservationName(String value) {
        this.value = value;
    }
    ...
    public boolean equals(Object other) {
        if (!(other instanceof ObservationName name)) {
            return false;
        }
