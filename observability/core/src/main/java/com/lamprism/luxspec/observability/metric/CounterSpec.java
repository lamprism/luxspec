...
public final class CounterSpec extends AbstractMetricSpec<Counter> {
    ...
    /**
     * Builds a counter specification.
     */
    public static final class Builder extends BuilderSupport<Counter, Builder> {
        private Builder(String name) {
            super(name, MetricKind.COUNTER);
        }

        public CounterSpec build() {
            return new CounterSpec(this);
        }
    }
}
