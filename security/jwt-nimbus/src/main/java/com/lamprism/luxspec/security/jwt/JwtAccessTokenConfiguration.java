...
/**
 * Defines trusted JWT access-token format and validation configuration.
 *
 * @author RollW
 */
public final class JwtAccessTokenConfiguration {
    ...
    /**
     * Creates immutable JWT access-token configuration.
     *
