...
public class AuthenticationDispatcherImpl implements AuthenticationDispatcher {
    ...
    public Authentication authenticate(Credentials credentials) {
        Credentials nonNullCredentials = Objects.requireNonNull(credentials, "credentials");
        Instant startedAt = clock.instant();
        Authenticator<?> authenticator = authenticators.get(nonNullCredentials.getClass());
        ...
        try {
            authentication = authenticate(authenticator, nonNullCredentials);
    ...
    private <C extends Credentials> Authentication authenticate(
