 ...
 * @author RollW
 */
public final class CredentialType<C extends Credential> {
    private final String name;
    private final Class<C> credentialClass;

    private CredentialType(String name, Class<C> credentialClass) {
        this.name = name;
     ...
     * @param credentialClass the exact Java credential class
     * @param <C>             the credential value type
     * @return the immutable credential type
     */
    public static <C extends Credential> CredentialType<C> of(
            String name,
            Class<C> credentialClass
    ) {
        requireCanonical(Objects.requireNonNull(name, "name"));
        return new CredentialType<>(name, Objects.requireNonNull(credentialClass, "credentialClass"));
    }
    ...
    /**
     * Returns the exact Java credential class used for registry dispatch.
     *
     * @return the credential Java class
     */
    public Class<C> getCredentialClass() {
