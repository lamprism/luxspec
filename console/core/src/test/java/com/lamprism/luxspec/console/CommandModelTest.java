...
class CommandModelTest {
    ...
    void createsTypedImmutableSpecifications() {
        OptionSpec<Integer> limit = OptionSpec.builder("--limit", ValueParsers.integer())
                .alias("-l")
                .valueLabel("NUMBER")
                .defaultValue(10)
    ...
    void rejectsRequiredValuesWithDefaults() {
        assertThrows(IllegalArgumentException.class, () -> OptionSpec
                .builder("--name", ValueParsers.string())
                .required()
                .defaultValue("demo")
                .build());
    ...
    void rejectsInvalidArgumentNamesDuringConstruction() {
        assertThrows(IllegalArgumentException.class, () -> ArgumentSpec
                ...
                .build());
        assertThrows(IllegalArgumentException.class, () -> ArgumentSpec
                .builder("name=value", ValueParsers.string())
                .build());
    }
    ...
    void rejectsConflictingCommandAliasesAndOptions() {
        ...
        OptionSpec<String> firstOption = OptionSpec.builder("--name", ValueParsers.string()).build();
        OptionSpec<String> secondOption = OptionSpec.builder("--name", ValueParsers.string()).build();
        ...
        OptionSpec<String> sharedOption = OptionSpec.builder("--shared", ValueParsers.string()).build();
    ...
    void requiresRepeatableArgumentsToBeLast() {
        CommandSpec command = CommandSpec.builder("copy")
                .arguments(List.of(
                        ArgumentSpec.builder("source", ValueParsers.string()).repeatable().build(),
                        ArgumentSpec.builder("target", ValueParsers.string()).build()
                ))
                .build();
