...
public interface ValueParser<T> {
     ...
     */
    static ValueParser<String> string() {
        return ValueParser::parseString;
    }

    /**
     * @return a parser for signed base-ten integers
     */
    static ValueParser<Integer> integer() {
        return ValueParser::parseInteger;
    }

    /**
     * @return a parser for signed base-ten long values
     */
    static ValueParser<Long> longValue() {
        return ValueParser::parseLong;
    }

    /**
     * @return a parser for decimal double values
     */
    static ValueParser<Double> doubleValue() {
        return ValueParser::parseDouble;
    }

    /**
     * @return a parser that accepts only true or false, ignoring case
     */
    static ValueParser<Boolean> booleanValue() {
        return ValueParser::parseBoolean;
    }
     ...
     */
    static <T> ValueParser<T> of(Function<String, T> converter) {
     ...
     */
    static <E extends Enum<E>> ValueParser<E> enumValue(Class<E> enumType) {
