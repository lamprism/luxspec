...
public final class CommandApplication {
    ...
    private CommandApplication(Builder builder, CommandCatalog catalog) {
        ...
        this.parser = new CommandParser(catalog,
                new CommandParser.Controls(helpCommand, helpOptionNames, versionOptionNames));
    }
    ...
    public CommandResult execute(String[] tokens) {
        return execute(tokens, CommandSessions.standard());
    }
    ...
    public CommandResult executeLine(String line) {
        return executeLine(line, CommandSessions.standard());
    }
    ...
    public static final class Builder {
        ...
        private HelpRenderer helpRenderer = new PlainTextHelpRenderer(HelpFormat.defaults());
