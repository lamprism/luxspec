...
tasks.named("check") {
    ...
    dependsOn(tasks.matching { it.name == "checkPomFileForMavenJavaPublication" })
}
            ...
            pom {
                ...
                developers {
                    developer {
                        ...
                        email.set(providers.gradleProperty("luxspec.pom.developer.email"))
                        organization.set(providers.gradleProperty("luxspec.pom.developer.organization"))
                        organizationUrl.set(providers.gradleProperty("luxspec.pom.developer.organizationUrl"))
                    }
                }
